 ...
 * @Last Modified time: 2018-04-17 23:52:36
        ...
        value: function _resolve(promise2, x) {
            ...
            if (x instanceof Promise) {
                ...
                if (x._PromiseStatus == 'pending') {
                    ...
                    promise2._decide('fufilled', x._PromiseValue);
...
//     var ff = new Promise(function(){

//     })
//     setTimeout(function () {
//         ff._decide('rejected', true)
//         console.log(ff._PromiseStatus)
//     }, 150)
